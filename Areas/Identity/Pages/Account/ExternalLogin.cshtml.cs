        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if((registeredUser != null) && (externalEmailUser != null))
                {
                    ...
                    {
                        // Liên kết tài khoản và tiến hành đăng nhập luôn
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Not associated account, please use another email!");
                        return Page();
                    }
                }
                ...
                {
                    ModelState.AddModelError(string.Empty, "Not supported to create a new account with diffirent email from an email from an external service");
                    return Page();
                }
                ...
                if((externalEmailUser == null) && (externalEmail == Input.Email))
                {
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "Not created a new account");
                        return Page();
                    }
                }
