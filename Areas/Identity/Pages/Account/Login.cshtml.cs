    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // lockoutOnFailure: true thì đăng nhập quá số lần sẽ bị khóa một thời gian
                ...
                {
                    ModelState.AddModelError(string.Empty, "Account not exists or wrong username, password");
                    return Page();
                }
            }
